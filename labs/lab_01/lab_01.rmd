...
This data frame has 33,703 rows and 63 columns
...
# I used the same code I just looked at the last page
...
Kanawha is West Virginia's most populated county and Wirt is West Virginia's least populated county.
...
Greenbriar Hotel Corporation received a loan for 8,912,202.They retained 500 jobs. 
...
James Conley Justice II owns the Greenbriar. He is the current governor of West Virginia. 
...
Despite the fact that Berkeley is the second most populated county in West Virginia, small buisinesses there have recieved almost three times less PPP loans than Kanawha County
